...
const getPluginConfig = (themeConfig) => {
  ...
  if (themeConfig.comment && themeConfig.author) themeConfig.comment.author = themeConfig.author
  return [
        ...
        ? Object.assign(
            {
              ...
              clipboardComponent: (0, path_1.resolve)(__dirname, '../components/Clipboard.vue')
            },
    ...
    [
      ...
      themeConfig.typescript
        ? {
            tsLoaderOptions:
              typeof themeConfig.typescript === 'object' ? themeConfig.typescript : {}
          }
        : false
    ],
    [
      clean_url_1.cleanUrlPlugin,
      themeConfig.cleanUrl === false ? false : themeConfig.cleanUrl || { normalSuffix: '/' }
    ],
    [
