...
const getRootLang = (config) => {
  ...
  if (
    (siteLocales === null || siteLocales === void 0 ? void 0 : siteLocales['/']) &&
    (0, vuepress_shared_1.checkLang)(
      (_a = siteLocales['/']) === null || _a === void 0 ? void 0 : _a.lang
    )
  )
  ...
  if (
    (themeLocales === null || themeLocales === void 0 ? void 0 : themeLocales['/']) &&
    (0, vuepress_shared_1.checkLang)(
      (_b = themeLocales['/']) === null || _b === void 0 ? void 0 : _b.lang
    )
  )
