...
const setThemeLocales = (themeConfig, rootLang) => {
  ...
  // set locate for base
  themeConfig.locales['/'] = Object.assign(
    Object.assign(
      Object.assign({}, (0, vuepress_shared_1.getLocale)(rootLang)),
  ...
  Object.keys(themeConfig.locales).forEach((path) => {
    ...
    themeConfig.locales[path] = Object.assign(
      Object.assign({}, (0, vuepress_shared_1.getLocale)(lang)),
...
const resolveThemeConfig = (themeConfig, rootLang) => {
  ...
  if (themeConfig.encrypt) (0, encrypt_1.resolveEncrypt)(themeConfig.encrypt)
}
