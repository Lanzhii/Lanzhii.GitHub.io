...
const isServer = (vNode) =>
  typeof vNode.componentInstance !== 'undefined' && vNode.componentInstance.$isServer
...
export const update = (el, binding) => {
  if (validate(binding) && el.$vueClickOutside) el.$vueClickOutside.callback = binding.value
}
