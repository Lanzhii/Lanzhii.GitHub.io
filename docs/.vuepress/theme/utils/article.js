...
export const getDate = (date) => {
  ...
  if (time.isValid()) {
    ...
    if ((hour === 8 || hour === 0) && minute === 0 && second === 0 && millisecond === 0)
...
export const compareDate = (dataA, dataB) => {
  ...
  const compare = (a, b) => {
    ...
    if (typeof b[0] === 'undefined') return typeof a[0] === 'undefined' || a[0] === 0 ? 0 : -1
...
export const filterArticle = (pages, filterFunc) =>
  pages.filter((page) => {
    const {
...
export const sortArticle = (pages, compareKey) =>
