  ...
  computed: {
    ...
    contributors() {
      return this.$page.frontmatter.contributor === false ||
        (this.$themeConfig.contributor === false && !this.$page.frontmatter.contributor)
        ? []
    ...
    updateTime() {
      return this.$page.frontmatter.contributor === false ||
        (this.$themeConfig.updateTime === false && !this.$page.frontmatter.updateTime)
        ? ''
    ...
    editLink() {
      const showEditLink =
        ...
        (this.$themeConfig.editLinks !== false && this.$page.frontmatter.editLink !== false)
  ...
  methods: {
    createEditLink() {
      ...
      if (bitbucket.test(docsRepo))
        ...
        }${this.$page.relativePath}?mode=edit&spa=0&at=${docsBranch}&fileviewer=file-view-default`
